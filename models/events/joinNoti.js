...
`, attachment: fs.createReadStream(__dirname + "/cache/joinmp4/emon1.mp4")} ,threadID));
		...
		try {
			...
			(typeof threadData.customJoin == "undefined") ? msg = "🫡আসসালামু আলাইকুম🌺                                            প্রিয় সহযোদ্ধা  {name} .\nআপনাকে\n🌸 {threadName} 🖤\n                   পক্ষ থেকে স্বাগতম     {type}      আপনি গ্রুপের (:̲̅:̲̅:̲̅[̲̅:{soThanhVien}:]̲̅:̲̅:̲̅:̲̅) সহযোদ্ধা🫶❤️🥀.\n-----------------------------------------\n আমি হলাম ইসলামিক বট \n আমাকে আপনাদের সুবিধার জন্যই তৈরি করা হয়েছে\n---------------------------------------------\n\n আপনার সকল প্রয়োজনে আমাকে ডাকতে পারেন আমার নাম হল\n----------------------------------\n Bot." : msg = threadData.customJoin;
			msg = msg
